    ...
    <tr>
        ...
        <td className='p-4'>
            <div className='flex gap-2 items-center justify-center'>
                <MdOutlineRemoveRedEye  size={35} className='border text-[#2563eb] border-[#2563eb] rounded-sm p-2 hover:text-gray-700 cursor-pointer'/>
                ...
                <RiDeleteBin6Line size={35} className='border text-[#dc2626] border-[#dc2626] rounded-sm p-2 hover:text-gray-700 cursor-pointer'/>
            </div>
        </td>
    </tr>
  )

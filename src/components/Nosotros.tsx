            ...
            <div className='container mx-auto px-4'>
                <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-12 my-15'>
                    ...
                    <div className='relative'>
                        <Image src='/images/Nosostros.jpg' alt='Fachada de la empresa Anclacentro en su local principal' width={600} loading='lazy' decoding='async'  height={500} className='shadow-2xl rounded-lg w-auto h-auto' />
                    </div>
                </div>
            </div>
    </section>
